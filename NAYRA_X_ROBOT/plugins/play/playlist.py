...
from NAYRA_X_ROBOT.utils import close_markup
from config import BANNED_USERS, SERVER_PLAYLIST_LIMIT
from NAYRA_X_ROBOT import Carbon, app
from NAYRA_X_ROBOT.utils.decorators.language import language, languageCB
from NAYRA_X_ROBOT.utils.inline.playlist import (botplaylist_markup,
                                              get_playlist_markup,
                                              warning_markup)
...
from NAYRA_X_ROBOT.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from NAYRA_X_ROBOT import YouTube
